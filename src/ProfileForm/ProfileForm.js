    ...
    <form className={classes.ProfileForm} onSubmit={handleSubmit(onSubmit)}>
      ...
      <label>
        ...
        <input
          ...
          className={errors.Username || isError ? classes.error : ''}
          {...register('Username', {
      ...
      <label>
        ...
        <input
          ...
          className={errors.Email || isError ? classes.error : ''}
          {...register('Email', {
      ...
      <label>
        ...
        <input
          ...
          className={errors.Password || isError ? classes.error : ''}
          {...register('Password', {
      ...
      <label>
        ...
        <input
          ...
          className={errors.Avatar || isError ? classes.error : ''}
          {...register('Avatar', {
