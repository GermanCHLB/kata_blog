...
const SignUpForm = () => {
  const {register, handleSubmit, setError, watch, formState: {errors}} = useForm({mode: 'onChange'})
  ...
  return (
    <form className={classes.SignUpForm} onSubmit={handleSubmit(onSubmit)}>
      ...
      <label>
        Username
        <input type="text" placeholder='Username' className={errors.Username ? classes.error : ''}
               {...register('Username', {
      ...
      <label>
        Email address
        <input type="text" placeholder='Email address' className={errors.Email ? classes.error : '' }
                {...register('Email', {
      ...
      <label>
        Password
        <input type="text" placeholder='Password' className={errors.Password ? classes.error : '' }
               {...register('Password', {
      ...
      <label>
        Repeat Password
        <input type="text" placeholder='Password' className={errors.PasswordRepeat ? classes.error : '' }
      ...
      <p className={classes.signIn}>Already have an account? <Link to='/sign-in'>Sign In</Link>.</p>
    </form>
  );
};
